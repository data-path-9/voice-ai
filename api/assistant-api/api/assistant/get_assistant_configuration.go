...
func (assistantApi *assistantGrpcApi) GetAssistantConfiguration(
	ctx context.Context,
	req *protos.GetAssistantConfigurationRequest,
	...
	configuration, err := assistantApi.assistantConfigService.Get(ctx, iAuth, req.GetId(), req.GetAssistantId())
	if err != nil {
		return &protos.GetAssistantConfigurationResponse{
			Code:    pkg_errors.AssistantConfigurationGet.HTTPStatusCodeInt32(),
			Success: false,
			Error: &protos.Error{
				ErrorCode:    uint64(pkg_errors.AssistantConfigurationGet.Code),
				ErrorMessage: pkg_errors.AssistantConfigurationGet.Error,
				HumanMessage: pkg_errors.AssistantConfigurationGet.ErrorMessage,
			},
		}, errors.New(pkg_errors.AssistantConfigurationGet.Error)
	}
