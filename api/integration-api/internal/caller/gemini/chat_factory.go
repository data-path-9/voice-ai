...
import (
	...
	internal_gemini_generate_content "github.com/rapidaai/api/integration-api/internal/caller/gemini/generate_content"
...
func NewChat(
	...
	case TransportGenerateContent:
		return internal_gemini_generate_content.NewChat(logger, credential)
	default:
		return nil, fmt.Errorf("unsupported gemini transport option: %s", transport)
	}
}
...
func NewChatStream(
	...
	switch transport {
	case TransportGenerateContent:
		return internal_gemini_generate_content.NewStream(logger, credential)
	default:
		return nil, fmt.Errorf("unsupported gemini transport option: %s", transport)
	}
}
